...
import {
  ...
  RemoveBookingModal,
} from "../../../components/mainscreens/bookings";
import { UnifiedHelpCenterModal } from "../../../../src/components/shared";
import { faqData } from "../../../data/faqData";
import BookingCard from "../../../components/mainscreens/bookings/sections/BookingCard";
import { useBookings } from "../../../hooks/BookingsContext";
import { useTheme } from "../../../hooks/ThemeContext";
import type { RootStackParamList } from "../../../types/navigation";
import PropertyDetailsScreen from "../../propertyBookingScreens/propertyDetails/PropertyDetailsScreen";
...
export default function BookingsScreen({
  ...
  const handleManageBooking = () => {
    if (selectedBookingId) {
      // When accessing from a BookingCard, verify the confirmation number matches the selected booking
      ...
      if (
        ...
        Alert.alert(
          ...
          "The confirmation number doesn't match this booking. Please check and try again.",
        );
        return;
      }
      ...
      // When accessing from the download icon, find booking by confirmation number
      const found = bookings.find(
        (b) =>
          b.details?.confirmationNumber ===
          confirmationInput.trim().toUpperCase(),
      );
      if (!found) {
            ...
            {activeBookings.map((item) => (
              <BookingCard
                ...
                onPress={() => {
                  ...
                  setConfirmationInput(""); // Clear previous input
  ...
  if (currentPage === "HelpSupport") {
    return <HelpSupportSection onBack={() => setCurrentPage("Bookings")} />;
  }
  ...
  return (
    <View style={styles.container}>
      ...
      <UnifiedHelpCenterModal
        ...
        colors={colors}
        insets={insets}
        activeTab={helpFaqTab}
        setActiveTab={setHelpFaqTab}
      ...
      <View style={styles.header}>
        ...
        <View style={styles.iconRow}>
          ...
          <TouchableOpacity
            onPress={() => {
              setSelectedBookingId(null); // Clear selected booking for general lookup
              setConfirmationInput(""); // Clear previous input
              setShowBookingDetailsModal(true);
            }}
          >
