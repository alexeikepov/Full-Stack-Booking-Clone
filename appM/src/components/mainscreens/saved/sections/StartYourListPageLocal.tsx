...
import { handleShare as handleShareUtil } from "../../../propertybookingscreens/propertyDetails/handlers/handleShare";
...
const StartYourListPageLocal: React.FC<StartYourListPageLocalProps> = ({
  ...
  const handleShare = async () => {
    let message = "Check out my next trip list on Booking.com!";
    if (savedProperties.length > 0) {
      message += "\n\nSaved properties:";
      message += savedProperties
        .map(
          (item, idx) =>
