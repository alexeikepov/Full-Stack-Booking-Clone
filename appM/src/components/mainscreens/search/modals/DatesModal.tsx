        ...
        <View key={monthIndex} style={{ marginBottom: 30 }}>
          ...
          <View style={styles.calendarGrid}>
            ...
            {Array.from({ length: monthData.daysInMonth }, (_, index) => {
              const day = index + 1;
              const selectedType = isDateSelected(
                monthData.year,
                monthData.month,
                day,
              );
              ...
              return (
                <TouchableOpacity
                  ...
                  style={[
                    styles.calendarDay,
                    selectedType === "checkin" && styles.checkInDay,
                    selectedType === "checkout" && styles.checkOutDay,
                    inRange && !selectedType && styles.rangeDay,
                  ]}
                  onPress={() =>
                ...
                >
                  <Text
                    style={[
                      ...
                      selectedType && styles.selectedDayText,
                      inRange && !selectedType && styles.rangeDayText,
                    ]}
                  >
                    {day}
                  </Text>
