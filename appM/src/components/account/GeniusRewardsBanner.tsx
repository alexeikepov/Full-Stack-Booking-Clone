...
const geniusLightImage = require("../../assets/images/genius-light.jpg");
const geniusPresentImage = require("../../assets/images/genius-present.png");
interface Style {
  container: ViewStyle;
  content: ViewStyle;
  ...
  const Banner = (
    ...
    >
      <View style={styles.content}>
        <Image
          source={theme === "light" ? geniusLightImage : geniusPresentImage}
          ...
          <View style={[styles.pageSection, { marginTop: 0 }]}>
            <View style={[styles.container, { backgroundColor: colors.card }]}>
              <Text style={[styles.mainText, { color: colors.text }]}>
                Hi Guest, check out your rewards
              </Text>
