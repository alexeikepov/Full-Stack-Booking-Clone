...
const genius1Image = require("../../assets/images/genius1.jpg");
const genius2Image = require("../../assets/images/genius2.jpg");
interface FaqItem {
  question: string;
  answer: string;
}
      ...
      >
        <View style={styles.userInfo}>
          <TouchableOpacity onPress={() => setOpenPhotoModal(true)}>
            <Image
              source={profileImage || placeHolderImage}
              style={[
                styles.profileImage,
        ...
        >
          ...
          <ScrollView style={styles.scrollView} ref={scrollViewRef}>
            <View style={styles.heroSection}>
              <Image
                source={genius1Image} // Using placeholder image
            ...
            <View style={styles.contentSection}>
              ...
              <Image
                source={genius2Image} // Using placeholder image
