...
type UnifiedHelpCenterModalProps = {
  visible: boolean;
  onClose: () => void;
  colors: any;
  insets?: any;
...
const UnifiedHelpCenterModal: React.FC<UnifiedHelpCenterModalProps> = ({
  visible,
  onClose,
  colors,
  insets,
  ...
  const dynamicInsets = insets || { top: 0, bottom: 20 };
      ...
      >
        ...
        <ScrollView
          contentContainerStyle={{
            flexGrow: 1,
            paddingBottom: dynamicInsets.bottom + 20,
          }}
        >
...
export default UnifiedHelpCenterModal;
