  ...
  const Banner = (
    <Pressable style={styles.container} onPress={() => setShowFullPage(true)}>
      <View style={styles.content}>
        <Image
          source={require("../../assets/images/genius-present.png")}
          style={{ width: 40, height: 40 }}
        />
        <View style={styles.textContainer}>
          <Text style={[styles.mainText, { flexShrink: 1 }]} numberOfLines={1}>
      ...
      <SafeAreaView style={[styles.fullContainer, { paddingTop: insets.top }]}>
        ...
        >
          ...
          <View style={styles.pageSection}>
            <Text style={styles.pageSectionTitle}>Genius Level 1 rewards</Text>
            ...
            <View style={styles.pageItemContainer}>
              ...
              <View style={styles.pageItemTextContainer}>
                <Text style={styles.pageItemMainText}>10% off rental cars</Text>
                <Text style={styles.pageItemSubText}>
