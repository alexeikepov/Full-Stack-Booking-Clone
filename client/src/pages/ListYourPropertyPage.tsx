...
body{margin:0;font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Helvetica,Arial,sans-serif;color:var(--ink-black);background:var(--body-bg)}
a{color:var(--blue);text-decoration:none}
a:hover{text-decoration:underline}

.wrap{max-width:1128px;margin:0 auto;padding:0 24px}
svg{display:block;overflow:visible}
.btn{display:inline-flex;align-items:center;justify-content:center;height:44px;padding:0 24px;border:0;border-radius:6px;background:var(--blue);color:#fff;font-weight:500;font-size:16px;cursor:pointer;text-decoration:none}
.btn:hover{background:#0059bc}

/* HEADER */
.page-header{background:var(--blue-darker);color:#fff;padding:12px 0}
...
/* HERO */
.hero{background:var(--blue-darker);color:#fff;padding:32px 0}
.hero-join-banner{display:inline-flex;align-items:center;gap:8px;background:#fff;color:var(--green);padding:4px 10px;border-radius:6px;font-size:14px;font-weight:500}
.hero-grid{display:grid;gap:32px;align-items:start;margin-top:24px}
...
.h1 .accent{display:block;background:linear-gradient(180deg,#31b4ff 0%,#0a6adf 100%);-webkit-background-clip:text;background-clip:text;color:transparent}
.subt{color:rgba(255,255,255,.9);font-size:20px;line-height:1.5;max-width:550px;margin:0}
...
.testimonial-card{background:#fff;border:1px solid var(--gold);border-radius:8px;padding:24px;position:relative}
...
.faq-question{display:flex;justify-content:space-between;align-items:center;font-size:16px;font-weight:500;cursor:pointer}
...
.footer h2{font-size:32px;margin:0 0 32px}
.footer-links-grid{display:grid;gap:32px;grid-template-columns:repeat(auto-fill,minmax(180px,1fr))}
.footer-col h4{margin:0 0 12px;font-size:16px;font-weight:bold}
...
`;
  ...
  const Tick = () => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41L9 16.17z" fill="#008009"/>
    </svg>
  );
        ...
        <section className="hero">
          <div className="wrap">
              <div className="hero-join-banner">
                  <b>Booking.com</b> | <span>Join 29,278,209 other listings already on Booking.com</span>
              </div>
            <div className="hero-grid">
              <div>
                <h1 className="h1">
                  List your
                  <span className="accent">holiday rental</span>
                  on Booking.com
                </h1>
                <p className="subt">
              ...
              <div className="card">
                <div className="card-b">
                  ...
                  <div className="card-row"><Tick /><span>Choose instant bookings or Request to Book</span></div>
          ...
          <div className="wrap">
            ...
            <div className="cols cols-3">
              <div className="col">
                ...
                <a href="#" className="btn" style={{ marginTop: 24 }}>Start registration</a>
        ...
        <section className="section" style={{ backgroundColor: "#f5f5f5" }}>
          <div className="wrap">
            ...
            <div className="cols cols-2">
              ...
              <a href="#" className="btn" style={{marginTop: "24px"}}>Start registration</a>
          </div>
        </section>
            ...
            <div className="wrap">
                ...
                <div className="cols cols-3">
                    <div className="col">
                        ...
                        <p className="feature-line" style={{alignItems:"center"}}>Seamlessly import your property information from other travel websites and avoid overbooking with calendar sync.</p>
                    </div>
                    <div className="col">
                        <h4>Start fast with review scores</h4>
                        <p className="feature-line" style={{alignItems:"center"}}>Your review scores on other travel websites are converted and displayed on your property page before your first Booking.com guests leave their reviews.</p>
                    </div>
                    <div className="col">
                        <h4>Stand out in the market</h4>
                        <p className="feature-line" style={{alignItems:"center"}}>The "New to Booking.com" label helps you stand out in our search results.</p>
                    </div>
                </div>
                <div style={{textAlign: "center", marginTop: "24px"}}><a href="#" className="btn">Start registration</a></div>
            </div>
        </section>
          ...
          <div className="wrap">
            ...
            <div className="testimonials-grid">
              <div className="testimonial-card">
                <p className="testimonial-quote">"I was able to list within 15 minutes, and no more than two hours later, I had my first booking!"</p>
                <div className="testimonial-author">
                    <div className="author-info">
                      <div className="name">Parley Rose</div>
                      <div className="role">UK-based Host</div>
                    </div>
                </div>
              </div>
              <div className="testimonial-card">
                <p className="testimonial-quote">"Booking.com is the most straightforward to work with. Everything is clear. It's easy. And it frees us up to focus on the aspects that we can really add value to, like the guest experience."</p>
                <div className="testimonial-author">
                    <div className="author-info">
                      <div className="name">Martin Fieldman</div>
                      <div className="role">Managing Director, Abodebed</div>
                    </div>
                </div>
              </div>
              <div className="testimonial-card">
                <p className="testimonial-quote">"After joining Booking.com and setting up my listing, my occupancy went up significantly and bookings were coming in five to six months in advance."</p>
                <div className="testimonial-author">
                    <div className="author-info">
                      <div className="name">Zoey Berghoff</div>
                      <div className="role">US-based Host</div>
                    </div>
                </div>
              </div>
            </div>
