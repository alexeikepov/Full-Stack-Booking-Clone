...
const FEATURES: Feature[] = [
  {
    titleKey: "home.travelMore.features.freeCancellation.title",
    subtitleKey: "home.travelMore.features.freeCancellation.subtitle",
    img: "https://t-cf.bstatic.com/design-assets/assets/v3.160.0/illustrations-traveller/FreeCancellation.png",
    imgAltKey: "home.travelMore.features.freeCancellation.imgAlt",
  },
  {
    titleKey: "home.travelMore.features.worldwide.title",
    subtitleKey: "home.travelMore.features.worldwide.subtitle",
    img: "https://t-cf.bstatic.com/design-assets/assets/v3.160.0/illustrations-traveller/TripsGlobe.png",
    imgAltKey: "home.travelMore.features.worldwide.imgAlt",
  },
  {
    titleKey: "home.travelMore.features.support247.title",
    subtitleKey: "home.travelMore.features.support247.subtitle",
    img: "https://t-cf.bstatic.com/design-assets/assets/v3.160.0/illustrations-traveller/CustomerSupport.png",
    imgAltKey: "home.travelMore.features.support247.imgAlt",
  },
];
...
export default function TravelMoreSection() {
  ...
  return (
    <section className="mx-auto w-full max-w-6xl px-4 md:px-6 lg:px-8 py-10">
        ...
        {FEATURES.map((f) => (
          <Card key={f.title} className="rounded-sm border p-5.5">
            <div className="flex items-start gap-4">
              ...
              <div>
                <div className="text-base font-bold leading-snug">{t(f.titleKey)}</div>
                <div className="mt-1 text-sm">{t(f.subtitleKey)}</div>
              </div>
            </div>
          </Card>
        ))}
      ...
      <h2 className="mt-12 text-[26px] font-bold">{t("home.travelMore.title")}</h2>

      <Card className="mt-4 rounded-sm border md:p-4">
        <div className="grid grid-cols-1 items-center gap-6 md:grid-cols-[1fr_150px]">
          <div>
            <h3 className="text-lg font-bold">{t("home.travelMore.boxTitle")}</h3>
            <p className="mt-1 text-sm">{t("home.travelMore.boxSubtitle")}</p>
