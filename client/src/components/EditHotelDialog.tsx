              ...
              {(showAll || activeTab === "advanced") && (
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          step="0.1"
                          value={
                            formData.propertyHighlights?.locationScore ?? 0
                          }
                          onChange={(e) =>
                            setFormData((p: any) => ({
                              ...p,
                      ...
                      <div>
                        ...
                        <Input
                          value={
                            formData.propertyHighlights?.locationDescription ||
                            ""
                          }
                          onChange={(e) =>
                            setFormData((p: any) => ({
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                      ...
                      <div>
                        ...
                        <Input
                          value={
                            formData.houseRules?.cancellation?.policy || ""
                          }
                          onChange={(e) =>
                            setFormData((p: any) => ({
                              ...p,
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      <div className="md:col-span-1">
                        ...
                        <Textarea
                          rows={3}
                          value={formData.overview?.infoAndPrices || ""}
                          onChange={(e) =>
                            setFormData((p: any) => ({
                              ...p,
                              overview: {
                      ...
                      <div className="md:col-span-1">
                        ...
                        <Textarea
                          rows={3}
                          value={formData.overview?.activity || ""}
                          onChange={(e) =>
                            setFormData((p: any) => ({
                              ...p,
                              overview: {
                      ...
                      <div className="md:col-span-1">
                        <Label className="text-xs">
                          Facilities (overview text)
                        </Label>
                        <Textarea
                          rows={3}
                          value={formData.overview?.facilities || ""}
                          onChange={(e) =>
                            setFormData((p: any) => ({
                              ...p,
                              overview: {
                      ...
                      <div className="md:col-span-1">
                        <Label className="text-xs">
                          House Rules (overview text)
                        </Label>
                        <Textarea
                          rows={3}
                          value={formData.overview?.houseRules || ""}
                          onChange={(e) =>
                            setFormData((p: any) => ({
                              ...p,
                              overview: {
                      ...
                      <div className="md:col-span-1">
                        ...
                        <Textarea
                          rows={3}
                          value={formData.overview?.finePrint || ""}
                          onChange={(e) =>
                            setFormData((p: any) => ({
                              ...p,
                              overview: {
                      ...
                      <div className="md:col-span-1">
                        <Label className="text-xs">
                          Guest Reviews (overview text)
                        </Label>
                        <Textarea
                          rows={3}
                          value={formData.overview?.guestReviews || ""}
                          onChange={(e) =>
                            setFormData((p: any) => ({
                              ...p,
                              overview: {
                      ...
                      <div className="md:col-span-1">
                        ...
                        <Textarea
                          rows={3}
                          value={formData.overview?.travellersAsking || ""}
                          onChange={(e) =>
                            setFormData((p: any) => ({
                              ...p,
                              overview: {
                      ...
                      <div className="md:col-span-1">
                        ...
                        <Textarea
                          rows={3}
                          value={formData.overview?.hotelSurroundings || ""}
                          onChange={(e) =>
                            setFormData((p: any) => ({
                              ...p,
                              overview: {
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2">
                      {(formData.travellersQuestions || []).map(
                        (q: any, i: number) => (
                          <div
                            key={i}
